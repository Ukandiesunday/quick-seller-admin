...
const CategoryForm = ({ toggleCategoryForm }: CategoryType) => {
  ...
  return (
    <div
      ...
      className=" w-full h-screen custom-bg-rgba fixed inset-0 flex justify-center xl:items-center z-50"
    >
      <form
        onSubmit={handleSubmit}
        onClick={(e) => e.stopPropagation()}
        className="bg-white h-screen w-full top-[5px]  md:max-w-[600px]  absolute   custom-rounded shadow-md p-[30px] overflow-y-scroll flex flex-col gap-[20px]"
      >
